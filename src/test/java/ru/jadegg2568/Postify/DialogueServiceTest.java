...
import ru.jadegg2568.Postify.repository.DialogueRepository;
import ru.jadegg2568.Postify.repository.MessageRepository;
...
class DialogueServiceTest {
    ...
    void sendMessage_checks_participation_and_saves() {
        ...
        when(userService.getByUuid(userAUuid)).thenReturn(userA);
        when(messageMapper.toEntity(dialogue, messageText)).thenReturn(expectedMessage);
